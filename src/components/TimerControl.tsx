  ...
  return (
    ...
    >
      ...
      <select
        ...
        className="mt-[3px] w-full min-w-0 rounded border border-neutral-700 bg-neutral-900 pl-1.5 pr-5 py-0.5 text-[11px] text-neutral-200 outline-none hover:border-neutral-600 focus:border-neutral-500 disabled:opacity-50"
      >
